...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Restaurant booking engine v10`}</title>

        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine v10 - Streamlining your dining experience by simplifying table reservations and menu management."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Restaurant booking engine v10`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine v10 - Streamlining your dining experience by simplifying table reservations and menu management.`}
            </Text>
            <Box
